...
public class Scenario134Test extends KimbleOneTest {

	@Test(groups = {"ScenarioTests"}, dataProvider = "yamlDataProvider", testName = "Scenario134")
	public void Scenario134(KimbleData loginCredentials, KimbleData kimbleTestData) throws Exception {
