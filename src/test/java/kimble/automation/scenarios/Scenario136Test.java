...
public class Scenario136Test extends KimbleOneTest {

	@Test(groups = {"ScenarioTests"}, dataProvider = "yamlDataProvider", testName = "Scenario136")
	public void Scenario136(KimbleData loginCredentials, KimbleData kimbleTestData) throws Exception {
